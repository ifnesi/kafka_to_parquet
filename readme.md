...
Datagen connector status (Purchase)
...
An HTML dashboard (`index.html`) will be created and it should be automatically open once generated and refreshed automatically:
